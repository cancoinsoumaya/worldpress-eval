...
<div id="header" class="menubar">
    <div class="toggle-nav mobile-menu">
        <button role="tab" onclick="vw_kids_menu_open_nav()"><i class="<?php echo esc_attr(get_theme_mod('vw_kids_res_open_menu_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','vw-kids'); ?></span></button>
    </div>
